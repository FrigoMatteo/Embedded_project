 ...
 * harware_init.c
 *
 * hardware intialization, even peripherals
 *
 */
...
const Timer_A_UpModeConfig upConfigTimerA0 = {
        ...
        TIMER_A_CLOCKSOURCE_DIVIDER_64,                 // ACLK/64 = 500 Hz
...
void adcInit () {
    ...
    ADC14_enableModule();
    ADC14_initModule(ADC_CLOCKSOURCE_ACLK, ADC_PREDIVIDER_64, ADC_DIVIDER_8, 0);
