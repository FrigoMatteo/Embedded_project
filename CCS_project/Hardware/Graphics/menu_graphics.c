 ...
 * menu_graphics.c
 *
 * all function needed to manage the display and all of its changes and all of the high level offsets and constants
 *
 */
...
#define drawStringCentered_witOffset(string, offset)\
        Graphics_drawStringCentered(&g_sContext,\
                                    (int8_t *)string,\
                                    AUTO_STRING_LENGTH,\
                                    offset_x_text + offset_interaction *offset,\
                                    offset_y_text, TRANSPARENT_TEXT)
...
// ARROWS
#define ARROW_1BPP_UNCOMP_COLOR_DIRECTION(palette, direction) {\
...
const Graphics_Image ARROW_1BPP_UNCOMP[16] = {
    // WHITE
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_WHITE_BLACK_1BPP_UNCOMP, pixel_UP_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_WHITE_BLACK_1BPP_UNCOMP, pixel_SX_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_WHITE_BLACK_1BPP_UNCOMP, pixel_DOWN_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_WHITE_BLACK_1BPP_UNCOMP, pixel_DX_1BPP_UNCOMP),
    // GREEN
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_GREEN_BLACK_1BPP_UNCOMP, pixel_UP_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_GREEN_BLACK_1BPP_UNCOMP, pixel_SX_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_GREEN_BLACK_1BPP_UNCOMP, pixel_DOWN_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_GREEN_BLACK_1BPP_UNCOMP, pixel_DX_1BPP_UNCOMP),
    // BLUE
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_BLUE_BLACK_1BPP_UNCOMP, pixel_UP_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_BLUE_BLACK_1BPP_UNCOMP, pixel_SX_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_BLUE_BLACK_1BPP_UNCOMP, pixel_DOWN_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_BLUE_BLACK_1BPP_UNCOMP, pixel_DX_1BPP_UNCOMP),
    // PURPLE
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_PURPLE_BLACK_1BPP_UNCOMP, pixel_UP_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_PURPLE_BLACK_1BPP_UNCOMP, pixel_SX_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_PURPLE_BLACK_1BPP_UNCOMP, pixel_DOWN_1BPP_UNCOMP),
    ARROW_1BPP_UNCOMP_COLOR_DIRECTION (palette_PURPLE_BLACK_1BPP_UNCOMP, pixel_DX_1BPP_UNCOMP),
};

// LETTERS FOR TIMEFRAME
#define CELL_1BPP_UNCOMP_COLOR(palette) {\
    IMAGE_FMT_1BPP_UNCOMP, \
    cell_width, \
    cell_height, \
    cell_size, \
...
const Graphics_Image BLACK_CELL_1BPP_UNCOMP =
    CELL_1BPP_UNCOMP_COLOR (palette_BLACK_1BPP_UNCOMP);

const Graphics_Image CELL_1BPP_UNCOMP[4] = {
    // WHITE
    CELL_1BPP_UNCOMP_COLOR (palette_WHITE_1BPP_UNCOMP),
    // GREEN
    CELL_1BPP_UNCOMP_COLOR (palette_GREEN_1BPP_UNCOMP),
    // BLUE
    CELL_1BPP_UNCOMP_COLOR (palette_BLUE_1BPP_UNCOMP),
    // PURPLE
    CELL_1BPP_UNCOMP_COLOR (palette_PURPLE_1BPP_UNCOMP),
};
...
void draw_current_menu () {
    ...
    char string[20];
    sprintf(string, "%4d A    %4d A", sensorsBuffer[5], minCurrent (sensorsBuffer));
...
void draw_mqtt_menu () {
    ...
    switch (curr_tf_mqtt) {
        ...
        case AT:
            drawStringMid (no_date, offset_y_mqtt_3);
            sprintf(string, "%03s/%4d %03s/%2d", MONTH[mqttBuffer[0][2] -1], mqttBuffer[0][3], MONTH[mqttBuffer[1][2] -1], mqttBuffer[1][3]);
            drawStringMid (string, offset_y_mqtt_4);
            break;
    }

    // DATA
    sprintf(string, "%4d A   %4d A", mqttBuffer[0][4], mqttBuffer[1][4]);
...
void alarm_screen () {
    ...
    drawStringMid ("ALARM", 30);
    drawStringMid ("Press a button to stop", 30);
}
